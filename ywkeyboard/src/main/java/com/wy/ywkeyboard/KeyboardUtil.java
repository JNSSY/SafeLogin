...
public class KeyboardUtil {
    ...
    private String name;//安全键盘标题
    private boolean touchfeedbaack = false;//触感反馈
     ...
     */
    public KeyboardUtil(Context ctx, LinearLayout rootView, ScrollView scrollView, String name, boolean touchfeedback) {
        this.mContext = ctx;
        this.mActivity = (Activity) mContext;
        this.name = name;
        this.touchfeedbaack = touchfeedback;
     ...
     */
    public KeyboardUtil(View view, Context ctx, LinearLayout root_View, ScrollView scrollView, String name, boolean touchfeedback) {
        this(ctx, root_View, scrollView, name, touchfeedback);
    ...
    private void initKeyBoardView(LinearLayout rootView) {
        ...
        rl_root = keyBoardLayout.findViewById(R.id.rl_root);
    ...
    public void initLayoutHeight(LinearLayout layoutView) {
        LinearLayout.LayoutParams keyboard_layoutLayoutParams = (LinearLayout.LayoutParams) layoutView
                .getLayoutParams();
        ...
        tv_close = (TextView) layoutView.findViewById(R.id.tv_close);
        tv_close.setOnClickListener(new finishListener());
...
//        keyboard_view_finish.setOnClickListener(new finishListener());
        if (keyboard_layoutLayoutParams == null) {
            ...
            keyboard_layoutLayoutParams.height = (int) (mActivity.getResources().getDisplayMetrics().heightPixels * SIZE.KEYBOARY_H);
        }
...
//				return;
    ...
    public void showKeyboard() {
        ...
        mActivity.getWindow().setNavigationBarColor(mContext.getResources().getColor(R.color.keyboard));
    }
    ...
    private void initKeyBoard(int keyBoardViewID) {
        ...
        keyboardView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (touchfeedbaack) {
                    if (event.getAction() == MotionEvent.ACTION_UP) {
//                        VibratorUtil.Vibrate(mActivity, 70);
    ...
    private void initInputType() {
        if (inputType == INPUTTYPE_NUM) {
            ...
            rl_root.setBackgroundColor(mContext.getResources().getColor(R.color.keyboard));
...
//        randomdnumkey(numKeyboard);
    ...
    private void hideKeyboard() {
        ...
        mActivity.getWindow().setNavigationBarColor(mContext.getResources().getColor(R.color.white));
    }
    ...
    private void randomdnumkey(Keyboard mKeyboard) {
        if (mKeyboard == null) {
            return;
        }
        ...
        for (int i = 0, size = keyList.size(); i < size; i++) {
            ...
            if (label != null && isNumAbc(label.toString())) {
                newkeyList.add(key);
            }
        }

        for (Key key : newkeyList) {
            Log.e("wy", key.label.toString());
        }
...
//        alist.add("0");alist.add("1");alist.add("2");alist.add("3");alist.add("4");
//        alist.add("5");alist.add("6");alist.add("7");alist.add("8");alist.add("9");
//
//
//        for (int i = 0; i < count; i++) {
//            temp.add(new KeyModel(48 + i, alist.get(i)));
//        }
...
//        }
    ...
    private boolean isNumAbc(String str) {
